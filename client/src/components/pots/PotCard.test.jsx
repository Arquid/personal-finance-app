...
describe("PotCard", () => {
  it("renders the pot name and formatted amounts", () => {
    render(<PotCard pot={basePot} onEdit={() => {}} onDelete={() => {}} onDeposit={() => {}} onWithdraw={() => {}} />);
  ...
  it("caps the progress percentage at 100% even if the pot is over-funded", () => {
    ...
    render(<PotCard pot={overfunded} onEdit={() => {}} onDelete={() => {}} onDeposit={() => {}} onWithdraw={() => {}} />);
  ...
  it("calls onDeposit with the pot when 'Add Money' is clicked", async () => {
    ...
    render(<PotCard pot={basePot} onEdit={() => {}} onDelete={() => {}} onDeposit={onDeposit} onWithdraw={() => {}} />);
  ...
  it("calls onWithdraw with the pot when 'Withdraw' is clicked", async () => {
    ...
    const user = userEvent.setup();
    render(<PotCard pot={basePot} onEdit={() => {}} onDelete={() => {}} onDeposit={() => {}} onWithdraw={onWithdraw} />);
  ...
  it("calls onDelete with the pot when 'Delete' is clicked", async () => {
    ...
    const user = userEvent.setup();
    render(<PotCard pot={basePot} onEdit={() => {}} onDelete={onDelete} onDeposit={() => {}} onWithdraw={() => {}} />);
